const phrases = [
  ...
  ['Checking GitHub for updates…','GitHub 업데이트 확인 중…','GitHub の更新を確認中…'], ['You have the latest version.','최신 버전입니다.','最新バージョンです。'],
  ['Version {version} is available.','{version} 버전을 사용할 수 있습니다.','バージョン {version} が利用可能です。'],
  ['Downloading update… {progress}%','업데이트 다운로드 중… {progress}%','更新をダウンロード中… {progress}%'],
  ['Update downloaded and verified.','업데이트 다운로드 및 검증 완료.','更新のダウンロードと検証が完了しました。'], ['Opening update…','업데이트 여는 중…','更新を開いています…'],
  ['Allow updates from Click in Android settings, then tap Install update again.','Android 설정에서 Click의 앱 설치를 허용한 뒤 업데이트 설치를 다시 누르세요.','Android の設定で Click からのインストールを許可し、もう一度「更新をインストール」を押してください。'],
  ['Use the desktop or Android app to install updates.','데스크톱 또는 Android 앱에서 업데이트를 설치하세요.','デスクトップまたは Android アプリで更新してください。'],
  ['Could not reach GitHub. Check your connection and try again.','GitHub에 연결할 수 없습니다. 인터넷 연결을 확인하고 다시 시도하세요.','GitHub に接続できません。接続を確認して再試行してください。'],
  ['GitHub is temporarily limiting update checks. Try again later.','GitHub 요청 한도에 도달했습니다. 잠시 후 다시 시도하세요.','GitHub の利用制限に達しました。後で再試行してください。'],
  ['This release does not have a compatible, verified update file.','이 릴리스에 호환되는 검증된 업데이트 파일이 없습니다.','このリリースには対応する検証済み更新ファイルがありません。'],
  ['The download failed verification. Check for updates to try again.','다운로드 검증에 실패했습니다. 업데이트를 다시 확인하세요.','ダウンロードの検証に失敗しました。もう一度更新を確認してください。'],
  ['This APK cannot update the installed app. Its signing key or package version does not match.','이 APK는 설치된 앱을 업데이트할 수 없습니다. 서명 키 또는 패키지 버전이 일치하지 않습니다.','この APK では更新できません。署名キーまたはパッケージバージョンが一致しません。'],
  ['Could not open the update. Check for updates to try again.','업데이트를 열 수 없습니다. 업데이트를 다시 확인하세요.','更新を開けません。もう一度更新を確認してください。'],
  ['Android will ask you to confirm installation. Your settings are kept.','Android에서 설치 확인을 요청합니다. 설정은 유지됩니다.','Android でインストールの確認が表示されます。設定は保持されます。'],
  ['Click will close and restart to apply the update. Your settings are kept.','업데이트를 적용하기 위해 Click을 종료하고 다시 시작합니다. 설정은 유지됩니다.','更新の適用時に Click を終了して再起動します。設定は保持されます。'],
  ...
  ['Start','시작','開始'], ['Pause','일시정지','一時停止'], ['Resume','재생','再開'],
  ['TIME SIGNATURE','박자표','拍子'],
  ['Open time signature menu','박자표 메뉴 열기','拍子メニューを開く'],
  ['Time signature {meter}, {division}, volume {volume}%. Open settings.','박자표 {meter}, {division}, 볼륨 {volume}%. 설정 열기.','拍子 {meter}、{division}、音量 {volume}%。設定を開く。'],
